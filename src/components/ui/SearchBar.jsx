    ...
    <div className="relative w-full">
      ...
      >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-4 bg-transparent text-white placeholder-gray-400 focus:outline-none transition-all duration-200 text-lg font-medium drop-shadow-sm"
            style={{
          ...
          <AnimatePresence>
            {searchTerm && (
              <motion.button
                ...
                className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-cyan-400 transition-colors z-10 p-1 rounded-full hover:bg-white/10 backdrop-blur-sm"
      ...
      <AnimatePresence>
        {isFocused && !searchTerm && (
          <motion.div
            className="absolute top-full mt-2 w-full bg-gray-900 border border-cyan-400/30 rounded-2xl shadow-2xl z-50 overflow-hidden"
          ...
          >
              ...
              <div className="grid grid-cols-2 gap-3">
                {searchSuggestions.map((suggestion, index) => (
                  <motion.button
                    ...
                    className="group text-left px-4 py-3 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-cyan-400/40 rounded-xl transition-all duration-300 flex items-center gap-3"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">Search projects</div>
                    </div>
                  </motion.button>
                ))}
              </div>
            ...
            <div className="px-6 py-3 bg-gray-800 border-t border-gray-700">
              <div className="text-xs text-gray-400 flex items-center gap-2">
                ...
                <span>Search by project name, description, or technology stack</span>
              </div>
            </div>
          </motion.div>
        )}
